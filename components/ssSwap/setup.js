...
function Setup() {
  ...
  const [threeQuartersValueButton, setThreeQuartersValueButton] =
    useState(false);
  ...
  const renderSmallInputSlippage = (
    type,
    amountValue,
    amountError,
    amountChanged
    ...
    return (
      <div className={classes.textField}>
        <div className={classes.maxContainer}>
          {type == "From" ? (
            <button
              onClick={(e) => setMax(e, assetValue.balance)}
          ...
          {type == "From" ? (
            <button
              onClick={(e) => setThreeQuarters(e, assetValue.balance)}
              className={classes.maxbtn}
            >
              75%
            </button>
          ...
          {type == "From" ? (
            <button
              onClick={(e) => setHalf(e, assetValue.balance)}
              className={classes.maxbtn}
            >
              50%
            </button>
          ...
          {type == "From" ? (
            <button
              onClick={(e) => setQuarter(e, assetValue.balance)}
              className={classes.maxbtn}
            >
              25%
            </button>
