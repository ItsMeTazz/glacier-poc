...
function SiteLogo(props) {
  ...
  return (
    <GlacierLogo href="/" viewBox="0 0 147.7 50"/>
    );
}
...
function Header(props) {
  ...
  return (
    <div>
      <Grid item container className={classes.mainHeader}>
        <Grid item lg={3} xs={12} className={classes.headerlogoSide}>
          ...
          <div className={classes.menubar}>
            <ListIcon size='large' onClick={() => setShowMobileHeader(!showMobileHeader) } />
          </div>
        </Grid>
          ...
          <div className={classes.headerLeft}>
            ...
            <div style={{display:"flex", gap:"5px"}}>
              ...
              {account && account.address ?
                <div>
                  <div style={{display:"grid", gridAutoFlow:"column", gap:"5px", alignItems:"center", border:"2px solid gray", padding:"2px"}}>
                    <Button
                      disableElevation
                      variant="contained"
                ...
                <Button
                  ...
                  style={{background: "linear-gradient(180deg, #F4F1F7 0%, #ECE3F3 44.13%, #8F7D9D 86.26%, #F6ECFD 100%)"}}>
                  {account && account.address && <div className={`${classes.accountIcon} ${classes.metamask}`}></div>}
      ...
      {showMobileHeader &&
        <Grid contaner item style={{ marginTop: "20px" }}>
      ...
      {chainInvalid ? (
        <div className={classes.chainInvalidError}>
          <div className={classes.ErrorContent}>
            ...
            <Button className={classes.switchNetworkBtn} variant="contained" onClick={() => switchChain()} >Switch to {process.env.NEXT_PUBLIC_CHAINID == '43113' ? 'Fuji Testnet' : 'Avalanche C-Chain'}</Button>
            <div style={{height: "100%", width:"11px", background:"linear-gradient(0deg, cyan, blue, purple,magenta, red)"}}></div>
            </div>
          </div>
        </div>
