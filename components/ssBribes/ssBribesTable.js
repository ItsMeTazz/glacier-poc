...
import { Button, Grid,Table, TableBody, TableCell, TableContainer, TableHead, TableRow, TableSortLabel, Typography, Tooltip, Toolbar, IconButton, TextField, InputAdornment } from '@material-ui/core';
...
const useStyles = makeStyles((theme) => ({
  ...
  buttonOverride: {
    color: '#fff',
    background: 'linear-gradient(266.44deg, #e61c8d 0%, #8900f2 100%)',
    fontWeight: '700',
