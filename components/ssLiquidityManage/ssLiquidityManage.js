      ...
      return (
        <div className={classes.depositInfoContainer}>
          <p className={classes.text}>
            {" "}
            Variable pools are for volatile assets (e.g. AVAX/USDC, BTC/ETH) and
            Stable for closely matched assets (e.g. DAI/USDC, wBTC/renBTC)
          </p>
          <Typography className={classes.depositInfoHeading}>
            Reserve Info
          </Typography>
    ...
    return (
      <div className={classes.textField}>
        <div className={classes.mediumInputContainer}>
          ...
          {value ? (
            <Typography className={classes.voltibtntext}>Stable</Typography>
          ) : (
            <Typography className={classes.voltibtntext}>Volatile</Typography>
          )}
          {/* </div> */}
                ...
                <div className={classes.inputsContainer}>
                  {activeTab === "deposit" && (
                    <>
                      ...
                      {isPair
                        ? renderMediumInputToggleIsPair("stable", stable)
                        : renderMediumInputToggle("stable", stable)}
                      {renderTokenSelect()}
