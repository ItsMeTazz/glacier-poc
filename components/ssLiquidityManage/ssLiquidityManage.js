...
import { Paper, Grid, Typography, Button, TextField, InputAdornment, CircularProgress, Container,Tooltip, IconButton, FormControlLabel, Switch, Select, MenuItem, Dialog } from '@material-ui/core'
...
export default function ssLiquidityManage() {
  ...
  const renderMediumInput = (type, value, logo, symbol) => {
    return (
      <div className={classes.textField}>
        <div className={classes.mediumInputContainer2}>
  ...
  const renderDepositInformation = () => {
    if (!pair) {
      ...
      return (
        <div className={classes.depositInfoContainer}>
          <p className={classes.text}> Variable pools are for volatile assets (e.g. AVAX/USDC, BTC/ETH) and Stable for closely matched assets (e.g. DAI/USDC, wBTC/renBTC)</p>
  ...
  const renderSmallInput = (type, amountValue, amountError, amountChanged) => {
    return (
      <div className={classes.textField} style={{border:"2px solid gray", width:"fit-content", padding:"5px"}}>
      ...
      <div className={classes.textField}>
        <div className={classes.mediumInputContainer}>
          <div className={classes.toggles}>
            ...
            <Typography className={classes.toggleOptionText}>Stable</Typography>            </div>
  ...
  const renderMediumInputToggleIsPair = (type, value) => {
    return (
      <div className={classes.textField}>
        <div className={classes.mediumInputContainer}>
          {/* <div className={classes.toggles}> */}
            {/* <div className={`${classes.toggleOption} ${stable && classes.active}`} onClick={() => { setStab(true) }}> */}
            {value?<Typography className={classes.voltibtntext}>Stable</Typography>:<Typography className={classes.voltibtntext}>Volatile</Typography>}   
                     {/* </div> */}
            {/* <div className={`${classes.toggleOption} ${!stable && classes.active}`} onClick={() => { setStab(false) }}>
              <Typography className={classes.toggleOptionText}>Volatile</Typography>
            </div> */}
        ...
        <div className={classes.mediumInputContainer2}>
          <div className={classes.mediumInputAmount}>
            <Select
              ...
              style={{background:"black",border:"2px solid gray", borderRadius:"0"}}
            >
              {vestNFTs && vestNFTs.map((option) => {
                return (
                  <MenuItem key={option.id} value={option} style={{background:"black",border:"2px solid gray", borderRadius:"0"}}>
  ...
  return (
   ...
   <Container>
   <Grid container item style={{display:"grid", gridAutoFlow:"column"}}>
      <Grid item md={6}>
      ...
      <div className={classes.stripeContainer}>
          ...
          <Tooltip title="Back to Liquidity" placement="top">
                <IconButton className={classes.backButton} onClick={onBack} style={{zIndex:"111"}}>
              ...
              <div className={classes.inputsContainer}>
                {
                  ...
                  <>
                    ...
                    {isPair?renderMediumInputToggleIsPair("stable",stable):renderMediumInputToggle('stable', stable)}
                    {renderTokenSelect()}
                ...
                <div className={classes.actionsContainer}>
                  {pair == null && asset0 && asset0.isWhitelisted == true && asset1 && asset1.isWhitelisted == true &&
                    ...
                    <Button
                      ...
                      >
                        {createLoading ? `Creating` : `Create Pair & Create Gauge`}
                  ...
                  { // There is a Gauge on the pair. Can deposit and stake
                    pair && (pair && pair.gauge && pair.gauge.address) &&
                    <>
                    <div className={classes.claimAllButton} style={{display:"grid", gridAutoFlow:"column", gap:"5px", alignItems:"center", border:"2px solid gray", padding:"2px", justifySelf:"center", width:"fit-content"}}>
                      ...
                      {advanced &&
                        ...
                        <div className={classes.claimAllButton} style={{display:"grid", gridAutoFlow:"column", gap:"5px", alignItems:"center", border:"2px solid gray", padding:"2px", justifySelf:"center", width:"fit-content"}}>
                          ...
                          <Button
                            ...
                            onClick={onStake}
                          >
                            {BigNumber(pair.balance).gt(0) ? (stakeLoading ? `Staking` : `Stake ${formatCurrency(pair.balance)} LP`) : `Nothing Unstaked`}
