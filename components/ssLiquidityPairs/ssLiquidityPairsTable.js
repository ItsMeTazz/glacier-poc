...
const useStyles = makeStyles((theme) => ({
  ...
  img1Logo: {
    ...
    borderRadius: "30px",
    background: "rgb(1,1,27)", //'rgb(25, 33, 56)',
  },
  img2Logo: {
    position: "absolute",
    left: "23px",
  ...
  return (
    <Toolbar className={classes.toolbar}>
      <Grid container spacing={2}>
        ...
        >
          <Grid item md={12}>
            <Typography variant="h1" className="themesh1">
              Pools
            </Typography>
            <Typography className={classes.pooltext}>
              Add liquidity and earn weekly rewards!
            </Typography>
          </Grid>
...
export default function EnhancedTable({ pairs }) {
  ...
  function tvlToFormatted(tvl) {
    if (tvl > 1000000) {
      return `${(tvl / 1000000).toFixed(3)}M`
    }
                ...
                .map((row, index) => {
                  ...
                  return (
                    <TableRow key={labelId} className={classes.assetTableRow}>
                      ...
                      <TableCell
                        className={
                          classes.cell + " " + classes.hiddenSmallMobile
                        }
                        align="right"
                      >
                      ...
                      <TableCell className={classes.cell} align="right">
                        <Typography variant="h2" className={classes.textSpaced}>
                          {parseFloat(row.apr).toFixed(2)}%
                        </Typography>
                      </TableCell>

                      <TableCell className={classes.cell} align="right">
                        <Typography variant="h2" className={classes.textSpaced}>
                          ${tvlToFormatted(row.tvl)}
                        </Typography>
                      </TableCell>
                      <TableCell
