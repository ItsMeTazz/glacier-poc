...
const EnhancedTableToolbar = (props) => {
  ...
  return (
    <Toolbar className={ classes.toolbar }>
      ...
      <Grid item md={12} style={{border:"2px solid gray", background:"black", padding:"20px"}}>
          <Typography variant='h1' className="themesh1">Vest</Typography>
          <Typography className={classes.pooltext}>Locking your $GLCR for longer periods of time gives you even greater voting power, which means even more rewards!</Typography>
          <Grid lg='auto' md={12} sm={12} xs={12} item>
          <div style={{display:"grid", gridAutoFlow:"column", gap:"5px", alignItems:"center", border:"2px solid gray", padding:"2px", width:"fit-content", justifySelf:"start", margin:"20px 0"}}>
              ...
              {stableSort(vestNFTs, getComparator(order, orderBy))
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell className={classes.cell} align='right' style={{display:"grid"}}>
                    <div style={{display:"grid", gridAutoFlow:"column", gap:"5px", alignItems:"center", border:"2px solid gray", padding:"2px", width:"fit-content", justifySelf:"end"}}>
                      <Button
                        variant='outlined'
                        color='primary'
                        onClick={() => {
