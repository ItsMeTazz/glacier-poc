    ...
    <div className={ classes.vestInfoContainer }>
      ...
      }
      {
        ...
        <div className={ classes.seccondSection }>
          <Typography className={ classes.info} color='textSecondary'>1 { govToken?.symbol } locked for 2 weeks = 0.25 { veToken?.symbol }</Typography>
          <Typography className={ classes.info} color='textSecondary'>1 { govToken?.symbol } locked for 4 weeks = 0.50 { veToken?.symbol }</Typography>
          <Typography className={ classes.info} color='textSecondary'>1 { govToken?.symbol } locked for 8 weeks = 0.75 { veToken?.symbol }</Typography>
          <Typography className={ classes.info} color='textSecondary'>1 { govToken?.symbol } locked for 12 weeks = 1.00 { veToken?.symbol }</Typography>
        </div>
      }
    </div>
  )
