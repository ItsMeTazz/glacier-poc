import { Typography, Button, Paper, SvgIcon, Grid, Avatar ,Container} from "@material-ui/core";
...
function Home({ changeTheme }) {
  ...
  return (
    ...
    //       <Grid item lg={12} md={12} sm={12} xs={12}>
    //         <Typography variant="h1" className={classes.secTitle}>Welcome to Equalizer</Typography>
    //       </Grid>
    //       <Grid item lg={12} md={12} sm={12} xs={12}>
    //         <Typography variant="body1" className={classes.mainDescription}>
    //           Equalizer officially launched in January 2022 with a collective goal of fair and balanced access to DeFi. Equalizer is a decentralized exchange that has launched on the Avalanche network with low fees, near 0 slippage on correlated assets and a strong focus on secondary markets for tokenized locks as NFT’s (veToken = lpNFTs).
    //         </Typography>
    //         <Typography variant="body2" className={classes.secDescription}>
    //           One segment of the cryptocurrency landscape that has shown incredible potential is the swapping of stablecoins and volatile assets. Equalizer Swap offers users quick, seamless and cheap transactions while utilizing strategies to maximize their yield.
    //         </Typography>
    //       </Grid>
    //       <Grid item lg={12} md={12} sm={12} xs={12}>
    ...
    <div className={classes.banner}>
      <div className={classes.bodymainidex}>
     <Container>
      <Grid container alignItems="center">
        <Grid item md={6}>
          <div className={classes.leftSideBanner}>
            <Typography variant="h1">
            Trading & Liquidity Hub<br/>For Avalanche
            </Typography>
            <div className={classes.buttonContainer}>
              <div className={classes.subButton}>
              <Button style={{height: "100%",border:"2px solid gray", padding:"20px", borderRadius: 0}} className={classes.buttonEnterSingle} onClick={() => router.push('/swap')}>Launch App</Button>
              ...
              <div className={classes.subButton}>
              <Button style={{height: "100%",border:"2px solid gray", padding:"20px", borderRadius: 0, background: "linear-gradient(180deg, #F4F1F7 0%, #ECE3F3 44.13%, #8F7D9D 86.26%, #F6ECFD 100%)", color: "black"}} className={classes.buttonEnterSingle} onClick={() => window.open("https://docs.glacier.exchange/")}>Documentation</Button>
              <div style={{height: "100%", width:"11px", background:"linear-gradient(0deg, cyan, blue, purple,magenta, red)"}}></div>
              </div>
            </div>
          </div>
