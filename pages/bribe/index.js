...
import ssBribeCreate from "../../components/ssBribeCreate/ssBribeCreate";
        ...
        <div className={classes.connected}>
         ...
         <Paper className={classes.notConnectedContent}>
           ...
           <Typography className={classes.mainDescNC} variant='body2'>
             Use your veGLCR to vote for your selected pool’s rewards distribution or create a bribe to encourage others to do the same.
           </Typography>
